...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        data_root=data_root,
        img_dir='postdam/img_dir/train',
        ann_dir='postdam/ann_dir/train',
        split='postdam/train.txt',
        B_img_dir = 'our/img_dir/train',
        B_split = 'our/train.txt',
        pipeline=train_pipeline),
    # target domain for validation
    val=dict(
        type=dataset_type,
        data_root=data_root,
        img_dir='our/img_dir/val',
        ann_dir='our/ann_dir/val', 
        split='our/val.txt',
